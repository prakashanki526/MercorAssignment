...
const Topbar = () => {
    return (
        <div className='h-[4.5rem] px-12 border-b-[1px] items-center flex justify-between w-full'>
            <div className='relative'>
                <input type='text' className='h-[44px] text-[14px] pl-10 pr-4 w-[417px] rounded-[6px] bg-[#f5f5f5] outline-none tracking-wide' placeholder='Search for anything...' />
