...
const Sidebar = () => {
    return (
        <div className='h-full w-full border px-3 py-6'>
            ...
            <div className='flex justify-center mt-10'>
                <div className='w-[206px] flex flex-col items-center bg-slate-100 h-[200px] relative rounded-2xl px-5'>
                    ...
                    <div className='my-2 h-[40px] w-full bg-white rounded-[4px] flex items-center justify-center text-black text-[14px] font-medium'>Write a message</div>
                </div>
